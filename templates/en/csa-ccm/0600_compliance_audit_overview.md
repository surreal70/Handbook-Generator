...
This document applies to all compliance activities, audits, regulatory requirements, and third-party management.
...
- [Industry 1]: [Requirements]
- [Industry 2]: [Requirements]

**Country-Specific Requirements**:
- [Country 1]: [Requirements]
- [Country 2]: [Requirements]
