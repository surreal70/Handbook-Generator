...
This template documents all interfaces of the Target of Evaluation (TOE) according to ISO/IEC 15408-1:2022.
It describes user interfaces, external interfaces, administrative interfaces, and internal interfaces.

Customization required:
- Document all user interfaces (GUI, CLI, API)
- Document external interfaces to other systems
- Document administrative interfaces
- Document internal interfaces between TOE components
- Describe interface protocols and security measures
- Create interface diagrams

Reference: ISO/IEC 15408-1:2022, Section 8.2.3 (TOE Interfaces)
-->
