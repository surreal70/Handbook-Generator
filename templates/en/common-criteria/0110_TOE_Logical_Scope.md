...
**Document-ID:** COMMON-CRITERIA-0110
...
This template documents the logical scope of the Target of Evaluation (TOE) according to ISO/IEC 15408-1:2022.
It defines all security functions, logical components, and functional capabilities of the TOE.

Customization required:
- List all security functions of the TOE
- Document logical components and modules
- Describe functional capabilities
- Define logical boundaries and exclusions
- Create functional architecture diagrams
- Document security mechanisms

Reference: ISO/IEC 15408-1:2022, Section 8.2.2 (TOE Logical Scope)
-->
