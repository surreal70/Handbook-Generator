...
This template documents the Security Problem Definition according to ISO/IEC 15408-1:2022.
It defines the threats, organizational security policies (OSPs), and assumptions
that justify the security requirements of the TOE.

Customization required:
- Identify all relevant threats to the TOE
- Define organizational security policies
- Document assumptions about the operational environment
- Describe threat agents and their capabilities
