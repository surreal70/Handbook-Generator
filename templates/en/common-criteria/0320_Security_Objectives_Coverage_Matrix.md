...
This template documents the Coverage Matrix for security objectives according to ISO/IEC 15408 (Common Criteria).

The Coverage Matrix is a tabular representation that shows:
1. Which security objectives address which threats
2. Which security objectives implement which OSPs
3. Which environment objectives fulfill which assumptions

The matrix serves as visual proof of:
- Completeness: All threats/OSPs/assumptions are covered
- Traceability: Clear mapping between objectives and security problems
- Clarity: Quick overview of relationships

Best Practices:
- Use clear markings (X, ✓, •) for mappings
- Keep the matrix up-to-date with changes
- Add comments for complex relationships
- Check for missing coverage (empty rows/columns)
-->
...
|------|--------|--------|--------|
| [Date] | Initial version | - | {{ meta-handbook.owner }} |
| **[TODO]** | | | |
