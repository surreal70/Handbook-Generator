...
This document describes the technology architecture for {{ source.organization_name }}, including technology platforms, infrastructure, network, and security architecture.
...
**Hosting Model**: {{ source.hosting_model }}
...
**Security Framework**: {{ source.security_framework }}

**Security Controls**:
- Identity and Access Management: {{ source.iam_controls }}
- Network Security: {{ source.network_security }}
- Data Protection: {{ source.data_protection }}

## Technology Standards

| Category | Standard | Version | Adoption Status |
|----------|----------|---------|-----------------|
...
<!-- Author notes: Technology architecture should enable business capabilities -->
