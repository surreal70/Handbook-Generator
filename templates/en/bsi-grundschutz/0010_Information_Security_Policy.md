...
The Information Security Policy of **{{ meta.organization.name }}** defines the strategic objectives and principles for the protection of information and IT systems.

### 1.1 Information Security Objective

**{{ meta.organization.name }}** commits to establishing information security as an integral part of corporate management. The objective is the appropriate protection of all information assets from threats and risks.

[TODO: Add specific security objectives of the organization]

### 1.2 Protection Values

The information security of **{{ meta.organization.name }}** is based on the following protection goals:
...
**{{ meta.organization.name }}** pursues a risk-based approach to information security according to BSI Standard 200-3. Security measures are implemented based on a systematic risk analysis and assessment.

### 3.2 Responsibilities and Resources

Executive management ensures that:
- Clear responsibilities for information security are defined
- Sufficient resources (personnel, budget, time) are provided
- Information security is considered in all business processes
...
### 3.4 Commitment to Compliance

**{{ meta.organization.name }}** commits to compliance with:
...
### 4.4 Information Domain Managers
...
## 5. Communication and Enforcement
...
Violations of this policy may result in the following measures:
- Warning
