...
This policy defines high-level principles for access control and permissions.
...
This policy defines the principles for access control and permissions at **{{ meta-organisation.name }}**.
...
- **Guideline 0210:** Guideline: IAM Joiner Mover Leaver and Recertification
...
- Examples: Configuration evidence, logs, audit reports
...
- Document 0210: Guideline: IAM Joiner Mover Leaver and Recertification
