...
This policy defines high-level principles for Endpoint Security.
...
This policy defines the principles for Endpoint Security at **{{ meta.organization.name }}**.
...
- **Guideline 0490:** Guideline: MDM EDR Device Compliance and Remote Work
