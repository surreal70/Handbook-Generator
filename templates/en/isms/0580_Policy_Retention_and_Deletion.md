...
This policy defines the requirements for retention and deletion of information and data at **{{ meta.organization.name }}**. It ensures compliance with legal retention obligations and adherence to data protection principles (data minimization, storage limitation).
