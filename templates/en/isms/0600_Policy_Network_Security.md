...
This policy defines the requirements for network security at **{{ meta-organisation.name }}**. It ensures that networks are properly secured, segmented, and monitored to protect the confidentiality, integrity, and availability of information.
