...
This policy defines the interfaces between information security and data protection at **{{ meta.organization.name }}**. It ensures that ISMS and data protection requirements are aligned and coordinated.
