...
This policy defines the principles for physical security at **{{ meta.organization.name }}**. It ensures that physical access to facilities, equipment, and information is controlled and monitored to prevent unauthorized access, theft, and damage.
