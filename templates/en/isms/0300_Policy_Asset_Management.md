...
This policy defines the principles for asset management and inventory control at **{{ meta.organization.name }}**. It ensures that all information assets are identified, documented, classified, and appropriately protected throughout their entire lifecycle.
