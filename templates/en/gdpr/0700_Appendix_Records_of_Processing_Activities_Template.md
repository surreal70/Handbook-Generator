...
<!-- 
This template is a template for the records of processing activities according to Art. 30 GDPR.

Customization required:
- Create an entry for each processing activity
...
If Yes:
- Countries: [TODO]
- Safeguards: [TODO: e.g., Standard contractual clauses, Adequacy decision]

### 6. Time Limits for Erasure
...
**If Yes:**  
- DPIA-ID: [TODO]
- Conducted on: [TODO: YYYY-MM-DD]
- Result: [TODO: Risk acceptable/not acceptable]
