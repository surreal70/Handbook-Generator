...
<!-- 
This template documents the records of processing activities according to Art. 30 GDPR.
It serves as a central register of all data processing in the organization.

Customization required:
- Record all processing activities systematically
- Document purposes, categories, recipients, deadlines
- Update records upon changes
- Ensure availability for supervisory authority
- Consider exceptions for companies < 250 employees
...
## Records for Controllers (Art. 30(1))

### Processing Activity 1: [TODO: Name of Processing]
...
#### h) Technical and Organizational Measures (Art. 32)
...
- Change of third country transfers

**Process:**
1. Identify change
2. Update records
3. Inform Data Protection Officer
...
## Provision to Supervisory Authority
