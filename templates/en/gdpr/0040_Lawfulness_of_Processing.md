...
<!-- 
This template documents the legal bases for processing personal data according to Art. 6 GDPR.
Every processing must be based on at least one legal basis.

Customization required:
- Identify legal basis for each processing activity
- Document consents and their management
- Check contractual necessity
- Assess legitimate interests and perform balancing test

Reference: GDPR Art. 6 (Lawfulness of processing)
-->
...
**Use Cases in our organization:**
- [TODO: e.g., Emergency contacts]
- [TODO: e.g., Health emergencies]
- [TODO: Only in exceptional cases]
...
## Review Process for New Processing
