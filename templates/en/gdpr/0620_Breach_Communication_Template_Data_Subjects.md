...
<!-- 
This template is a template for notifying data subjects about a data breach according to Art. 34 GDPR.

Customization required:
- Adapt language to your target audience (clear, understandable, non-technical)
- Complete all [TODO] fields
- Provide concrete, actionable recommendations
- Provide contact options
- Have Data Protection Officer and Communications Lead review

Reference: GDPR Art. 34 (Communication to data subject)
-->
...
**Example:**
```
On [Date], we discovered that due to a technical error, personal data of 
customers was temporarily accessible to unauthorized parties. The error was 
fixed on [Date].
```
...
**Example:**
```
There is a risk that third parties could use your contact data for 
unwanted advertising or phishing attempts.
```
...
**Example:**
1. We immediately fixed the error
2. We strengthened our security measures
3. We informed the competent data protection authority
4. We initiated a comprehensive investigation
