...
<!-- 
This template documents roles and responsibilities in data protection according to Art. 4 GDPR.
It defines the terms controller, processor, data subject and other roles.

Customization required:
- Identify all controllers in the organization
- Document processors and their contracts
- Designate Data Protection Officer (if required)
- Define roles and responsibilities in data protection team
- Create RACI matrix for data protection processes

Reference: GDPR Art. 4 (Definitions), Art. 24-39 (Controller and Processor)
-->
...
- **Qualification:** [TODO: Professional qualities]

**Tasks of DPO (Art. 39):**
- Inform and advise controller and employees
...
- Approval of data protection policies
...
- IT security concept
- Incident response
- Cooperation with Data Protection Officer

**Contact:** [TODO: Name, Contact]

## RACI Matrix Data Protection Processes
