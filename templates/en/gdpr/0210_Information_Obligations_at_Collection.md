...
<!-- 
This template documents the information obligations when collecting personal data according to Art. 13-14 GDPR.

Customization required:
- Create privacy notices for all collection situations
- Document information obligations for direct and indirect collection
- Describe exceptions to information obligations
- Implement processes for timely information

Reference: GDPR Art. 13 (Information to be provided where personal data are collected from the data subject), Art. 14 (Information to be provided where personal data have not been obtained from the data subject)
-->
...
| Contact Details of DPO | If applicable | [TODO: privacy@organization.com] |
...
- At first contact with data subject

## Information Obligation for Indirect Collection (Art. 14)
...
|-------------|-------------|
| Categories of Personal Data | Which data types | [TODO: Master data, contact data] |
| Source of Data | Where data comes from | [TODO: Public registers, partners] |
| Publicly Accessible Source | If applicable | [TODO: Commercial register] |
...
- At latest when disclosing to third parties

## Exceptions to Information Obligation

### Art. 13(4) - Already Informed

**No information required when:**
- Data subject already has the information

### Art. 14(5) - Exceptions for Third Party Collection
...
**In case of impossibility/disproportionate effort:**
...
- All privacy notices and their versions
- Time of provision
- Method of provision
...
3. Establish version control for privacy notices
