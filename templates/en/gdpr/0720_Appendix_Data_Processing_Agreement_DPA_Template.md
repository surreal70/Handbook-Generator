...
<!-- 
This template is a template for a Data Processing Agreement (DPA) according to Art. 28 GDPR.

Customization required:
- Complete all [TODO] fields
- Adapt TOMs to specific processing
- Have contract legally reviewed
- Ensure both parties sign
- Store contract securely

Reference: GDPR Art. 28 (Processor)
-->
...
### 4.3 Technical and Organizational Measures (TOM)
...
The Contractor supports the Principal with:
- Responding to data subject requests
- Reporting data breaches
- Conducting data protection impact assessments
- Prior consultations with supervisory authorities

### 4.5 Deletion and Return
