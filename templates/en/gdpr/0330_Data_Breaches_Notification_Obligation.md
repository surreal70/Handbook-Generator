...
<!-- 
This template documents handling of data breaches according to Art. 33-34 GDPR.
It describes notification obligations to supervisory authority and data subjects.

Customization required:
- Define incident response process
- Create notification procedure for supervisory authority (72-hour deadline)
- Define criteria for notification of data subjects
- Implement documentation obligation
- Create communication plans

Reference: GDPR Art. 33 (Notification to supervisory authority), Art. 34 (Communication to data subject)
-->
