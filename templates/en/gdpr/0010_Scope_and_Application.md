...
<!-- 
This template documents the scope and application of GDPR according to Art. 2-3.
It defines which processing activities fall under GDPR and which are exempt.

Customization required:
- Define material scope (which processing activities)
- Define territorial scope (establishment principle, targeting principle)
- Identify exceptions from scope
- Document cross-border processing
- Consider national derogations

Reference: GDPR Art. 2 (Material Scope), Art. 3 (Territorial Scope)
-->
...
### Establishment Principle (Art. 3(1))
...
### Representative Obligation (Art. 27)
...
Special categories of personal data are subject to enhanced protection requirements:
...
- [TODO: e.g., national data protection laws]
- [TODO: Sector-specific regulations]
- [TODO: Other national adaptations]
...
- **As needed:** Upon significant changes in processing activities
- **For new products/services:** Before introduction
