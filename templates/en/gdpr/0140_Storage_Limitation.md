...
<!-- 
This template documents the principle of storage limitation according to Art. 5(1)(e) GDPR.

Customization required:
- Define deletion periods for all processing activities
- Document deletion concept and deletion processes
- Describe exceptions and retention periods
- Implement automated deletion routines
