...
This document describes die laufenden Evaluierungsprozesse at {{ source.organization_name }} in accordance with COSO Prinzip 16.

## Scope

- In Geschäftsprozesse integrierte Überwachung
- Kontinuierliche Kontrollüberwachung
- Automatisierte Überwachungsmechanismen
- Management-Überwachungsaktivitäten

## Definition und Characteristics

### Definition

{{ source.ongoing_evaluations_definition }}

### Characteristics laufender Evaluierungen
...
- Systemgesteuerte Genehmigungsworkflows
- Automatische Plausibilitätsprüfungen
- Systemgenerierte Warnmeldungen
...
## In Processe integrierte Überwachung
...
## Überwachung durch Mitaratter

### Mitaratterverantwortung
...
**Alle Mitaratter**: {{ source.employee_responsibilities }}
