...
This template documents Workstation Use and Workstation Security (Physical Safeguards).
It aligns with HIPAA Security Rule §164.310(b) and §164.310(c).

Required (R) Standards:
- Workstation Use (R)
