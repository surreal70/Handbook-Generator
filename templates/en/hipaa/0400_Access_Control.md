...
This template documents Access Control (Technical Safeguard).
It aligns with HIPAA Security Rule §164.312(a)(1) - Access Control.

Required (R) Standard with Implementation Specifications:
