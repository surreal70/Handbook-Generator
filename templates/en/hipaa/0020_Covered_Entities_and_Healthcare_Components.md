...
This template documents the organization's status as a Covered Entity and defines healthcare components.
It aligns with HIPAA definitions in 45 CFR §160.103.

Customization required:
- Define covered entity type and functions
- Document healthcare components for hybrid entities
- List all covered functions and activities
- Identify workforce members in covered functions
-->
