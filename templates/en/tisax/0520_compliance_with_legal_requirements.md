...
This document describes measures for compliance with legal requirements according to TISAX requirements.

## Scope

This document applies to all activities of {{ source.organization_name }}.
...
- To affected persons: Without undue delay
- Documentation of all incidents

### Security Incidents
**IT Security Act:**
- Reporting to authorities for critical infrastructures
- Timely reporting
- Documentation

### Contractual Reporting Obligations
**TISAX:**
- Reporting to customers according to contract
- Timely information
