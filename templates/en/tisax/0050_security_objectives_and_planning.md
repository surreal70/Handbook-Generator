...
This document applies to all information security activities and projects.
...
1. **Security Incidents**: Number per month
2. **Training Rate**: Percentage of trained employees
3. **Vulnerabilities**: Number of open critical/high vulnerabilities
4. **Compliance Rate**: Percentage of met requirements
