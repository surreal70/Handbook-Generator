...
<!-- 
Dieses Template dokumentiert den Grundsatz der Speicherbegrenzung gemäß Art. 5 Abs. 1 lit. e DSGVO.

Anpassung erforderlich:
- Definiere Löschfristen für alle Verarbeitungstätigkeiten
- Dokumentiere Löschkonzept und Löschprozesse
- Beschreibe Ausnahmen und Aufbewahrungsfristen
- Implementiere automatisierte Löschroutinen

Referenz: DSGVO Art. 5 Abs. 1 lit. e (Speicherbegrenzung)
-->
