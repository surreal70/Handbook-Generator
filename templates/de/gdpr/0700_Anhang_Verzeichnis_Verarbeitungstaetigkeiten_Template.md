...
<!-- 
Dieses Template ist eine Vorlage für das Verzeichnis der Verarbeitungstätigkeiten gemäß Art. 30 DSGVO.

Anpassung erforderlich:
- Erstelle einen Eintrag für jede Verarbeitungstätigkeit
- Halte das Verzeichnis aktuell
- Stelle sicher, dass alle erforderlichen Informationen enthalten sind
- Mache das Verzeichnis der Aufsichtsbehörde auf Anfrage verfügbar
...
Falls Ja:
- Länder: [TODO]
- Garantien: [TODO: z.B. Standardvertragsklauseln, Angemessenheitsbeschluss]
...
**Falls Ja:**  
- DSFA-ID: [TODO]
- Durchgeführt am: [TODO: YYYY-MM-DD]
- Ergebnis: [TODO: Risiko akzeptabel/nicht akzeptabel]
