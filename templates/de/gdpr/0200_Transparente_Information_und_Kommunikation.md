...
<!-- 
Dieses Template dokumentiert die Anforderungen an transparente Information und Kommunikation gemäß Art. 12 DSGVO.

Anpassung erforderlich:
- Definiere Kommunikationskanäle für Betroffenenanfragen
- Dokumentiere Prozesse zur Beantwortung von Anfragen
- Beschreibe Maßnahmen zur verständlichen Kommunikation
- Implementiere Fristen und Verfahren

Referenz: DSGVO Art. 12 (Transparente Information, Kommunikation und Modalitäten für die Ausübung der Rechte der betroffenen Person)
-->
...
- Vermeidung von Juristensprache
...
**Mehrsprachigkeit:**
- [TODO: Deutsch als Hauptsprache]
- [TODO: Englisch für internationale Nutzer]
- [TODO: Weitere Sprachen bei Bedarf]
...
|-------|--------------|------------------|----------------|
| [TODO: E-Mail] | datenschutz@organisation.de | 1 Monat | DSB |
...
### Bearbeitungsfristen (Art. 12 Abs. 3)

**Grundfrist:**
- Unverzüglich, spätestens innerhalb eines Monats nach Eingang

**Verlängerung:**
- Um weitere zwei Monate bei komplexen Anfragen
- Begründung der Verlängerung erforderlich
- Information der betroffenen Person innerhalb eines Monats
...
|-------------|-------|----------------|------------|
| Eingangsbestätigung | 2 Werktage | DSB-Team | DSB |
| Identifikation | 5 Werktage | DSB-Team | DSB |
...
### Zweifel an der Identität (Art. 12 Abs. 6)

**Bei begründeten Zweifeln:**
- Anforderung zusätzlicher Informationen zur Identitätsbestätigung
- Keine Bearbeitung bis zur Identitätsbestätigung
- Information der anfragenden Person
- Dokumentation der Zweifel und Maßnahmen

## Unentgeltlichkeit

### Grundsatz der Kostenfreiheit (Art. 12 Abs. 5)

**Informationen und Maßnahmen sind grundsätzlich unentgeltlich.**

**Ausnahmen (Gebühren zulässig):**
- Offenkundig unbegründete Anfragen
- Exzessive Anfragen (insbesondere häufige Wiederholung)

**Gebührenordnung:**
- Angemessene Gebühr basierend auf Verwaltungskosten
- Begründung der Gebühr erforderlich
- Information der betroffenen Person vor Bearbeitung

### Ablehnung von Anfragen

**Anfragen können abgelehnt werden, wenn:**
- Offenkundig unbegründet
- Exzessiv (häufige Wiederholung)

**Prozess bei Ablehnung:**
1. Begründung der Ablehnung
2. Information über Beschwerderecht bei Aufsichtsbehörde
3. Information über gerichtliche Rechtsbehelfe
4. Dokumentation der Ablehnung
...
|-------|------------------|-----------------|-------------------|-------|------------|
| [TODO] | [TODO] | [TODO: Auskunft] | [TODO: In Bearbeitung] | [TODO: 30.XX.XXXX] | [TODO] |

### Nachweispflichten

**Für Accountability dokumentieren:**
- Alle eingegangenen Anfragen
- Bearbeitungsschritte und -zeiten
- Identifikationsmaßnahmen
- Antworten und Ablehnungen
- Gebühren und deren Begründung
...
**Schulungsinhalte:**
- Betroffenenrechte und deren Bedeutung
- Bearbeitungsprozesse und Fristen
...
- DSB-Team: Quartalsweise Updates
...
- **Löschung (Art. 17):** Bearbeitung von Löschanfragen
...
3. Definieren Sie Identifikationsverfahren
