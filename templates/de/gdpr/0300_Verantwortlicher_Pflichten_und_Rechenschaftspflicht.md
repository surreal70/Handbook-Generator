...
<!-- 
Dieses Template dokumentiert die Pflichten des Verantwortlichen gemäß Art. 24 DSGVO.
Es beschreibt die Rechenschaftspflicht und die Umsetzung geeigneter technischer und organisatorischer Maßnahmen.

Anpassung erforderlich:
- Dokumentiere implementierte technische und organisatorische Maßnahmen
- Erstelle Nachweisdokumentation für Compliance
- Definiere Prozesse zur regelmäßigen Überprüfung der Maßnahmen
- Berücksichtige Art, Umfang, Umstände und Zwecke der Verarbeitung
- Dokumentiere Risikobewertung und Maßnahmenangemessenheit

Referenz: DSGVO Art. 24 (Verantwortung des für die Verarbeitung Verantwortlichen)
-->

## Zweck

Dieses Dokument beschreibt die Pflichten des Verantwortlichen gemäß Art. 24 DSGVO und die Umsetzung der Rechenschaftspflicht bei {{ meta-organisation.name }}. Es dokumentiert, wie wir sicherstellen, dass die Verarbeitung personenbezogener Daten im Einklang mit der DSGVO erfolgt.
...
| Datenschutzverletzungs-Register | Art. 33 Compliance | Bei Vorfällen | [TODO: Rolle] |
...
|----------|--------------|----------------------|----------------|
| Zugangskontr olle | [TODO: Beschreibung] | Implementiert/Geplant | [TODO: Rolle] |
...
| Maßnahme | Beschreibung | Implementierungsstatus | Verantwortlich |
|----------|--------------|----------------------|----------------|
| Datenschutzrichtlinien | [TODO: Beschreibung] | Implementiert/Geplant | [TODO: Rolle] |
...
| Vertraulichkeitsverpflichtungen | [TODO: Beschreibung] | Implementiert/Geplant | [TODO: Rolle] |
...
## Datenschutz durch datenschutzfreundliche Voreinstellungen (Art. 25 Abs. 2)
...
- Opt-in statt Opt-out für nicht-notwendige Verarbeitung
...
**Überprüfungszyklen:**
- **Jährliche Überprüfung:** Vollständige Bewertung aller TOM
- **Quartalsweise Überprüfung:** Kritische Systeme und Hochrisiko-Verarbeitungen
- **Ad-hoc Überprüfung:** Bei Sicherheitsvorfällen, neuen Bedrohungen, Systemänderungen
