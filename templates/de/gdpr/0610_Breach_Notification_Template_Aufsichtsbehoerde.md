...
<!-- 
Dieses Template ist eine Vorlage für die Meldung einer Datenschutzverletzung an die Aufsichtsbehörde gemäß Art. 33 DSGVO.

Anpassung erforderlich:
- Fülle alle [TODO]-Felder aus
- Stelle sicher, dass alle erforderlichen Informationen enthalten sind
- Lasse durch Datenschutzbeauftragten prüfen
- Hole Freigabe von Geschäftsführung
- Übermittle innerhalb 72 Stunden ab Kenntnisnahme

Referenz: DSGVO Art. 33 (Meldung an Aufsichtsbehörde)
-->

## Meldung einer Datenschutzverletzung gemäß Art. 33 DSGVO
...
**Beispiel:**
```
Am [Datum] um [Uhrzeit] wurde festgestellt, dass durch eine Fehlkonfiguration 
des Webservers personenbezogene Daten von Kunden über einen Zeitraum von 
[Zeitraum] öffentlich zugänglich waren. Die Daten waren über eine nicht 
geschützte API-Schnittstelle abrufbar.
```
...
|----------------|--------------|------------------------------|
| [TODO: z.B. Stammdaten] | [TODO: Name, Adresse, Geburtsdatum] | [ ] Ja [X] Nein |
| [TODO: z.B. Kontaktdaten] | [TODO: E-Mail, Telefon] | [ ] Ja [X] Nein |
| [TODO: z.B. Finanzdaten] | [TODO: Kontonummer, Kreditkarte] | [ ] Ja [X] Nein |
...
### Maßnahmen zur Behebung der Datenschutzverletzung
...
### Maßnahmen zur Abmilderung der nachteiligen Auswirkungen
...
**Falls Ja:**
- Zeitpunkt: [TODO: YYYY-MM-DD]
- Methode: [TODO: E-Mail/Brief/Öffentliche Bekanntmachung]
- Anzahl benachrichtigter Personen: [TODO]
...
Falls Ja:
- Behörde: [TODO: z.B. Polizei, Staatsanwaltschaft]
- Aktenzeichen: [TODO]
- Datum: [TODO: YYYY-MM-DD]
