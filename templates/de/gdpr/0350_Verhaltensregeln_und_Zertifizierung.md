...
<!-- 
Dieses Template dokumentiert Verhaltensregeln und Zertifizierungen gemäß Art. 40-43 DSGVO.
Es beschreibt die Teilnahme an Verhaltensregeln und Datenschutz-Zertifizierungen.

Anpassung erforderlich:
- Prüfe verfügbare Verhaltensregeln für die Branche
- Evaluiere relevante Datenschutz-Zertifizierungen
- Dokumentiere Teilnahme an Verhaltensregeln
- Dokumentiere erhaltene Zertifizierungen
- Plane Rezertifizierungen

Referenz: DSGVO Art. 40-41 (Verhaltensregeln), Art. 42-43 (Zertifizierung)
-->

## Zweck

Dieses Dokument beschreibt die Teilnahme von {{ meta-organisation.name }} an Verhaltensregeln und Datenschutz-Zertifizierungen gemäß Art. 40-43 DSGVO. Diese dienen als Nachweis der Compliance und können die Rechenschaftspflicht unterstützen.

## Verhaltensregeln (Art. 40-41)

### Zweck von Verhaltensregeln (Art. 40 Abs. 1)
...
### Überwachung der Einhaltung (Art. 41)

**Überwachungsstelle:** [TODO: Name der akkreditierten Stelle]  
**Kontakt:** [TODO: Kontaktdaten]  
...
### Zweck der Zertifizierung (Art. 42 Abs. 1)
...
#### Sicherheits-Zertifizierungen (unterstützend)
...
### Gültigkeitsdauer und Rezertifizierung (Art. 42 Abs. 7)
...
### Überwachung und Widerruf (Art. 42 Abs. 8, Art. 43 Abs. 4)
...
**Widerrufsgründe:**
- Nichteinhaltung der Zertifizierungskriterien
- Schwerwiegende Datenschutzverletzungen
- Verweigerung der Überwachung
- Täuschung bei der Zertifizierung

## Verwendung von Siegeln und Prüfzeichen
...
- Geschäftsdokumente: [TODO: z.B. Angebote, Verträge]
- Marketing-Materialien: [TODO: z.B. Broschüren]

**Verwendungsrichtlinien:**
- Korrekte Darstellung des Siegels
- Angabe der Gültigkeitsdauer
- Verweis auf Zertifizierungsstelle
- Keine irreführende Verwendung

### Transparenz gegenüber Betroffenen

Betroffene Personen werden über die Zertifizierung informiert:
...
| Interne Ressourcen | [TODO: Personentage] | [TODO: Personentage] |
...
|---------|----------------|----------------------|-------------|------------|
| Zertifizierungsauswahl | [TODO] | [TODO] | [TODO] | [TODO] |
