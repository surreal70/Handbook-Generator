...
<!-- 
Dieses Template dokumentiert das Recht auf Berichtigung und Löschung gemäß Art. 16-17 DSGVO.

Anpassung erforderlich:
- Definiere Prozesse für Berichtigungs- und Löschanträge
- Dokumentiere Ausnahmen vom Löschrecht
- Beschreibe Benachrichtigungspflichten an Empfänger
- Implementiere Fristen und Verfahren

Referenz: DSGVO Art. 16 (Recht auf Berichtigung), Art. 17 (Recht auf Löschung)
-->
