...
<!-- 
Dieses Template dokumentiert die Auftragsverarbeitung gemäß Art. 28 DSGVO.
Es beschreibt die Anforderungen an Auftragsverarbeiter-Verträge und die Kontrolle von Auftragsverarbeitern.

Anpassung erforderlich:
- Liste alle Auftragsverarbeiter auf
- Dokumentiere Auftragsverarbeiter-Verträge (AVV)
- Definiere Auswahlkriterien für Auftragsverarbeiter
- Implementiere Kontrollmechanismen
- Dokumentiere Sub-Auftragsverarbeiter

Referenz: DSGVO Art. 28 (Auftragsverarbeiter), Art. 29 (Verarbeitung unter der Aufsicht des Verantwortlichen oder des Auftragsverarbeiters)
-->
...
1. **Bedarfsanalyse:** Anforderungen definieren
2. **Marktanalyse:** Potenzielle Dienstleister identifizieren
3. **Vorauswahl:** Anhand Auswahlkriterien
4. **Due Diligence:** Detaillierte Prüfung
5. **Vertragsverhandlung:** AVV-Abschluss
6. **Freigabe:** Durch Datenschutzbeauftragten
7. **Onboarding:** Integration und Schulung

## Auftragsverarbeiter-Vertrag (AVV)

### Pflichtinhalte gemäß Art. 28 Abs. 3
...
### Sub-Auftragsverarbeiter-Verzeichnis
...
### Kontrollrechte (Art. 28 Abs. 3 lit. h)
...
**Meldeprozess:**
1. Unverzügliche Meldung an: [TODO: Kontakt]
2. Informationen: Art der Verletzung, betroffene Daten, Maßnahmen
3. Frist: Innerhalb von [TODO: z.B. 24 Stunden]
...
### Löschung oder Rückgabe (Art. 28 Abs. 3 lit. g)
