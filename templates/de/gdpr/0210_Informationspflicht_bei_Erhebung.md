...
<!-- 
Dieses Template dokumentiert die Informationspflichten bei Erhebung personenbezogener Daten gemäß Art. 13-14 DSGVO.

Anpassung erforderlich:
- Erstelle Datenschutzerklärungen für alle Erhebungssituationen
- Dokumentiere Informationspflichten bei direkter und indirekter Erhebung
- Beschreibe Ausnahmen von der Informationspflicht
- Implementiere Prozesse zur rechtzeitigen Information

Referenz: DSGVO Art. 13 (Informationspflicht bei Erhebung), Art. 14 (Informationspflicht bei Dritterhebung)
-->
...
| Kontaktdaten DSB | Falls vorhanden | [TODO: datenschutz@organisation.de] |
...
| Drittlandübermittlung | Falls zutreffend | [TODO: USA, Standardvertragsklauseln] |
...
- Bei Erstkontakt mit der betroffenen Person

## Informationspflicht bei indirekter Erhebung (Art. 14)

### Zusätzliche Pflichtinformationen

**Bei Erhebung von Dritten zusätzlich:**

| Information | Beschreibung |
|-------------|--------------|
| Kategorien personenbezogener Daten | Welche Datenarten | [TODO: Stammdaten, Kontaktdaten] |
| Quelle der Daten | Woher stammen die Daten | [TODO: Öffentliche Register, Partner] |
| Öffentlich zugängliche Quelle | Falls zutreffend | [TODO: Handelsregister] |

### Zeitpunkt der Information

**Information muss erfolgen:**
- Innerhalb einer angemessenen Frist (max. 1 Monat)
- Spätestens bei erster Kommunikation
- Spätestens bei Offenlegung an Dritten

## Ausnahmen von der Informationspflicht

### Art. 13 Abs. 4 - Bereits informiert

**Keine Information erforderlich, wenn:**
- Betroffene Person bereits über die Informationen verfügt

### Art. 14 Abs. 5 - Ausnahmen bei Dritterhebung
...
**Bei Unmöglichkeit/unverhältnismäßigem Aufwand:**
- Geeignete Maßnahmen zum Schutz der Rechte
...
## Checkliste für Datenschutzerklärungen
...
- Alle Datenschutzerklärungen und deren Versionen
...
3. Etablieren Sie Versionsverwaltung für Datenschutzerklärungen
