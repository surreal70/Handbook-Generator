...
<!-- 
Dieses Template dokumentiert den Grundsatz der Richtigkeit gemäß Art. 5 Abs. 1 lit. d DSGVO.

Anpassung erforderlich:
- Definiere Prozesse zur Sicherstellung der Datenrichtigkeit
- Dokumentiere Verfahren zur Datenaktualisierung
- Beschreibe Maßnahmen zur Fehlerkorrektur
- Implementiere Berichtigungsrechte der betroffenen Personen

Referenz: DSGVO Art. 5 Abs. 1 lit. d (Richtigkeit)
-->
...
## Maßnahmen zur Sicherstellung der Richtigkeit
...
| [TODO: Aktualisierungsaufforderung] | Erinnerung an Datenaktualisierung | IT | [TODO: Jährlich] |

### Eingabevalidierung

**Technische Maßnahmen bei Dateneingabe:**
- [TODO: Formatprüfung (E-Mail, Telefon, PLZ)]
- [TODO: Pflichtfeldprüfung]
- [TODO: Wertebereichsprüfung]
- [TODO: Duplikatsprüfung]
- [TODO: Konsistenzprüfung zwischen Feldern]
...
### Umsetzung des Berichtigungsrechts
...
**Fehlerquellen:**
- Eingabefehler bei Datenerfassung
- Veraltete Daten durch Zeitablauf
- Fehlerhafte Datenübermittlung
- Systemfehler bei Datenverarbeitung
- Unvollständige Datenerhebung

**Fehlererkennung:**
- [TODO: Automatische Plausibilitätsprüfung]
- [TODO: Meldung durch betroffene Personen]
- [TODO: Regelmäßige Datenqualitätsprüfung]
- [TODO: Rückmeldungen von Empfängern]
...
|--------------|-------------------------|----------|---------------|
| Auftragsverarbeiter | Ja | Unmöglich/unverhältnismäßig | Benachrichtigungsprotokoll |
| Dritte Empfänger | Ja | Unmöglich/unverhältnismäßig | Benachrichtigungsprotokoll |
| Öffentliche Stellen | Ja | Unmöglich/unverhältnismäßig | Benachrichtigungsprotokoll |
...
- Fehlerquote bei Dateneingabe
- Anzahl Berichtigungsanträge
...
- Prozesse zur Sicherstellung der Richtigkeit
- Berichtigungsverfahren und -fristen
- Bearbeitete Berichtigungsanträge
- Benachrichtigungen an Empfänger
- Datenqualitätskontrollen und deren Ergebnisse

### Berichtigungsregister
...
3. Richten Sie Berichtigungsverfahren gemäß Art. 16 ein
