...
**Dokument-ID:** COMMON-CRITERIA-0410
...
This template documents the selection and justification of the Evaluation Assurance Level (EAL)
for the TOE. The EAL determines the depth and rigor of the security evaluation.

Key considerations:
- EAL ranges from EAL1 (functionally tested) to EAL7 (formally verified design and tested)
- Higher EALs require more rigorous development processes and documentation
- EAL selection should balance security needs with development costs and time
- The selected EAL determines the mandatory Security Assurance Requirements (SARs)
- Augmentation (adding SARs beyond the EAL package) is possible and should be justified
-->
