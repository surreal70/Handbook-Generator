...
**Dokument-ID:** COMMON-CRITERIA-0050
...
Dieses Template definiert Dokumentationskonventionen, Terminologie, Notation und Formatierungsstandards,
die im gesamten Security Target gemäß ISO/IEC 15408 verwendet werden.

Anpassung erforderlich:
- Füge TOE-spezifische Terminologie und Definitionen hinzu
- Definiere TOE-spezifische Abkürzungen und Akronyme
- Dokumentiere Diagrammkonventionen, falls zutreffend
- Liste informative Referenzen spezifisch für den TOE auf
- Stelle Konsistenz der Terminologie im gesamten ST sicher

Referenz: ISO/IEC 15408-1:2022 (Allgemeine Konventionen)
