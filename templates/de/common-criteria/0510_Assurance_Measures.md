...
Assurance Measures beschreiben die Maßnahmen, die ergriffen werden, um die Sicherungsanforderungen (SARs)
zu erfüllen. Diese Maßnahmen demonstrieren, dass das TOE korrekt entwickelt, getestet und dokumentiert wurde.

WICHTIGE HINWEISE:
- Jede SAR muss durch mindestens eine Assurance Measure abgedeckt sein
- Beschreibe konkrete Maßnahmen, nicht nur abstrakte Konzepte
- Verweise auf spezifische Dokumente, Prozesse und Artefakte
- Stelle sicher, dass die Maßnahmen dem gewählten EAL entsprechen
-->
...
<!-- 
ANLEITUNG:
- Gib das gewählte EAL an (EAL1 bis EAL7)
- Erkläre kurz, warum dieses EAL gewählt wurde
- Verweise auf die Bedrohungsanalyse und Sicherheitsziele
-->
...
<!-- 
ANLEITUNG:
Configuration Management stellt sicher, dass alle TOE-Komponenten und Dokumentation
unter Versionskontrolle stehen und Änderungen nachvollziehbar sind.
-->
...
<!-- 
ANLEITUNG:
Delivery and Operation stellt sicher, dass das TOE sicher ausgeliefert und
...
<!-- 
ANLEITUNG:
Development-Assurance stellt sicher, dass das TOE-Design und die Implementierung
...
<!-- 
ANLEITUNG:
Guidance Documents stellen sicher, dass Administratoren und Benutzer das TOE
sicher konfigurieren und verwenden können.
-->
...
<!-- 
ANLEITUNG:
Life Cycle Support stellt sicher, dass das TOE in einer sicheren Umgebung
entwickelt wird und sichere Entwicklungspraktiken verwendet werden.
-->
...
<!-- 
ANLEITUNG:
Tests stellen sicher, dass das TOE korrekt funktioniert und die SFRs erfüllt.
-->
...
<!-- 
ANLEITUNG:
Vulnerability Assessment stellt sicher, dass das TOE gegen bekannte Angriffe
resistent ist.
-->
