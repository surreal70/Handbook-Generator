...
Dieses Template dokumentiert die Coverage Matrix (Abdeckungsmatrix) für Sicherheitsziele gemäß ISO/IEC 15408 (Common Criteria).

Die Coverage Matrix ist eine tabellarische Darstellung, die zeigt:
1. Welche Sicherheitsziele welche Bedrohungen adressieren
2. Welche Sicherheitsziele welche OSPs umsetzen
3. Welche Umgebungsziele welche Annahmen erfüllen

Die Matrix dient als visueller Nachweis für:
- Vollständigkeit: Alle Bedrohungen/OSPs/Annahmen sind abgedeckt
- Rückverfolgbarkeit: Klare Zuordnung zwischen Zielen und Sicherheitsproblemen
- Übersichtlichkeit: Schneller Überblick über Beziehungen

Best Practices:
- Verwende klare Markierungen (X, ✓, •) für Zuordnungen
- Halte die Matrix aktuell bei Änderungen
- Ergänze Kommentare für komplexe Beziehungen
- Prüfe auf fehlende Abdeckungen (leere Zeilen/Spalten)
-->
