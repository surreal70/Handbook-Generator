...
Dieses Template dokumentiert den logischen Umfang des Target of Evaluation (TOE) gemäß ISO/IEC 15408-1:2022.
Es definiert alle Sicherheitsfunktionen, logischen Komponenten und funktionalen Fähigkeiten des TOE.

Anpassung erforderlich:
- Liste alle Sicherheitsfunktionen des TOE auf
- Dokumentiere logische Komponenten und Module
- Beschreibe funktionale Fähigkeiten
- Definiere logische Grenzen und Ausschlüsse
- Erstelle funktionale Architekturdiagramme
- Dokumentiere Sicherheitsmechanismen

Referenz: ISO/IEC 15408-1:2022, Abschnitt 8.2.2 (TOE Logical Scope)
-->
