...
Dieses Dokument beschreibt die Prozessebenen-Kontrollen (Process-Level Controls) bei {{ source.organization_name }}.

## Geltungsbereich

- Prozessspezifische Kontrollen
...
**Prozessspezifisch**: {{ source.process_specific }}
...
**Autorisierung**: {{ source.authorization_objective }}
...
**Autorisierung und Ausführung**: {{ source.authorization_execution_separation }}
...
**Prozessflussdiagramme**: {{ source.process_flow_diagrams }}
**Prozessbeschreibungen**: {{ source.process_descriptions }}
