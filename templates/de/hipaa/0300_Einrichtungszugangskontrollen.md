...
Dieses Template dokumentiert Einrichtungszugangskontrollen (Physical Safeguard).
Es entspricht der HIPAA Security Rule §164.310(a)(1) - Facility Access Controls.

Erforderlicher (R) Standard mit adressierbaren (A) Implementierungsspezifikationen:
- Notfallbetrieb (A)
- Einrichtungssicherheitsplan (A)
- Zugriffskontroll- und Validierungsverfahren (A)
- Wartungsaufzeichnungen (A)
-->
