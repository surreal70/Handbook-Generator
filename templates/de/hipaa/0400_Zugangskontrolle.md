...
Dieses Template dokumentiert Zugangskontrolle (Technical Safeguard).
Es entspricht der HIPAA Security Rule §164.312(a)(1) - Access Control.

Erforderlicher (R) Standard mit Implementierungsspezifikationen:
- Eindeutige Benutzeridentifikation (R)
- Notfallzugangsverfahren (R)
- Automatische Abmeldung (A)
- Verschlüsselung und Entschlüsselung (A)
-->
