...
Dieses Template dokumentiert Mitarbeitersicherheit (Administrative Safeguard).
Es entspricht der HIPAA Security Rule §164.308(a)(3) - Workforce Security.

Erforderlicher (R) Standard mit adressierbaren (A) Implementierungsspezifikationen:
- Autorisierung und/oder Überwachung (A)
- Verfahren zur Mitarbeiterfreigabe (A)
- Kündigungsverfahren (A)
-->
