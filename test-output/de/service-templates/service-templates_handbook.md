...
- **Service Owner:** Andreas Huemmer (andreas.huemmer@adminsend.de)
- **Technical Lead:** [TODO: Name und Kontakt]
- **On-Call:** [TODO: Rufbereitschaft-Kontakt]

### Eskalationspfad
1. **Level 1:** Service Desk - Julia Becker (julia.becker@adminsend.de)
2. **Level 2:** IT Operations - Andreas Huemmer (andreas.huemmer@adminsend.de)
3. **Level 3:** CIO - Anna Schmidt (anna.schmidt@adminsend.de)
