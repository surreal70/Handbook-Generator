...
Dieses Dokument beschreibt den Prozess zur Identifizierung, Bewertung und Behandlung von Betrugsrisiken gemäß COSO Internal Control Framework und Trust Services Kriterien CC2.
...
Die Organisation bewertet das Potenzial für Betrug bei der Erreichung ihrer Ziele. Eine umfassende Betrugsrisikobewertung ist entscheidend für die Entwicklung effektiver Kontrollen zur Verhinderung, Erkennung und Reaktion auf Betrug.

## Betrugsrisiko-Framework
...
**Finanzberichterstattungsbetrug**:
- Umsatzmanipulation
- Vermögenswertüberbewertung
...
1. **Bewertungsdokumentation**:
   - Betrugsrisikobewertung
   - Risikoinventar
   - Bewertungsmatrizen

2. **Kontrollendokumentation**:
   - Kontrollbeschreibungen
   - Kontrolldesign
   - Kontrolltests

3. **Untersuchungsdokumentation**:
...
- COSO Internal Control Framework - Risikobewertung
- AICPA Trust Services Criteria CC2
- ACFE Fraud Examiners Manual
- IIA Practice Guide: Fraud Risks and Controls
