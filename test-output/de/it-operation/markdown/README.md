...
**Organisation:**
- `AdminSend GmbH` - Organisationsname
- `Musterstraße 123` - Adresse
- `München` - Stadt
- `80331` - Postleitzahl
- `Deutschland` - Land
- `https://www.adminsend.de` - Website
- `+49 89 12345678` - Telefon
- `info@adminsend.de` - E-Mail
...
**Dokument:**
- `IT Operations Manager` - Dokumentverantwortlicher
- `CIO` - Genehmiger
- `1.0.0` - Version
- `internal` - Klassifizierung
...
|---|---|---|---|---|
| 1.0.0 | 2024-01-15 | Andreas Huemmer [andreas.huemmer@adminsend.de] | Initiale Version | CIO |
| 1.1.0 | 2024-02-20 | Andreas Huemmer [andreas.huemmer@adminsend.de] | Monitoring-Abschnitt erweitert | CIO |
```
...
|---|---:|---|---|
| Verfügbarkeit | 99.9% | Uptime-Monitoring | Andreas Huemmer |
| Antwortzeit | < 200ms | APM-Tool | Andreas Huemmer |
| MTTR | < 4h | Incident-Tracking | Julia Becker |
```
