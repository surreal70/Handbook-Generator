...
The IT security handbook of AdminSend GmbH comprises approximately 40 structured documents covering all essential aspects of an Information Security Management System (ISMS) according to BSI IT-Grundschutz.
...
**CEO:** Max Mustermann (max.mustermann@adminsend.de)
**CIO:** Anna Schmidt (anna.schmidt@adminsend.de)
**CISO/ISB:** Thomas Weber (thomas.weber@adminsend.de)
