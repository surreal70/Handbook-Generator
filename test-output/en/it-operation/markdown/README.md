...
**Organization:**
- `AdminSend GmbH` - Organization name
- `Musterstraße 123` - Address
- `München` - City
- `80331` - Postal code
- `Deutschland` - Country
- `https://www.adminsend.de` - Website
- `+49 89 12345678` - Phone
- `info@adminsend.de` - Email
...
**Document:**
- `IT Operations Manager` - Document owner
- `CIO` - Approver
- `1.0.0` - Version
...
|---|---|---|---|---|
| 1.0.0 | 2024-01-15 | Andreas Huemmer [andreas.huemmer@adminsend.de] | Initial version | CIO |
| 1.1.0 | 2024-02-20 | Andreas Huemmer [andreas.huemmer@adminsend.de] | Extended monitoring section | CIO |
```
...
|---|---:|---|---|
| Availability | 99.9% | Uptime monitoring | Andreas Huemmer |
| Response time | < 200ms | APM tool | Andreas Huemmer |
