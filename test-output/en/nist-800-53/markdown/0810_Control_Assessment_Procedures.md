...
**Assessment Team:**
| Role | Name | Responsibilities | Independence |
|------|------|------------------|--------------|
...
|----------|-------------|---------------------|
| Critical | Control not implemented or ineffective | Immediate |
| High | Significant deficiency | 30 days |
| Medium | Moderate deficiency | 90 days |
| Low | Minor deficiency | 180 days |

### 2.5 Remediation and Follow-up
